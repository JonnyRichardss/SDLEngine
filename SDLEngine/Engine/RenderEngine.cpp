...
RenderEngine::RenderEngine()
{
    ...
    window = SDL_CreateWindow("Jonathan Richards -- 26541501 : Brian VS Some Dudes", (mode.w - WINDOW_WIDTH) / 2, (mode.h - WINDOW_HEIGHT) / 2, WINDOW_WIDTH, WINDOW_HEIGHT, SDL_WINDOW_SHOWN);
