...
namespace InputActions {
	...
	enum Action { UP, DOWN, LEFT, RIGHT, ATTACK1, ATTACK2 ,DASH};//this is a little precarious but it should work, just make sure that you update the number and then you can update and access a bool for each action
	constexpr int NumActions = 7;
}
class InputHandler
{
public:
